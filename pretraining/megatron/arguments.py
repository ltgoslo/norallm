...
def _add_network_size_args(parser):
    ...
    group.add_argument('--n_loops', type=int, default=1)
...
def _add_logging_args(parser):
    ...
    group.add_argument('--log-validation-ppl-to-tensorboard',
                       ...
                       'tensorboard.')
    group.add_argument('--wandb_name', type=str, default="Norwegian GPT")
...
def _add_training_args(parser):
    ...
    group.add_argument('--embedding-checkpoint', type=str, default=None)
    group.add_argument('--transformer-checkpoint', type=str, default=None)
    group.add_argument('--num_kv_attention_heads', type=int, default=None)
...
def _add_learning_rate_args(parser):
    ...
    group.add_argument('--lr-decay-style', type=str, default='linear',
                       choices=['constant', 'linear', 'cosine', 'inverse_sqrt', 'trapezoidal'],
    ...
    group.add_argument('--lr-warmup-samples', type=int, default=0,
                       ...
                       'learning rate over.')
    group.add_argument('--lr-cooldown-samples', type=int, default=0,
                          help='number of samples to cooldown learning rate over.')
