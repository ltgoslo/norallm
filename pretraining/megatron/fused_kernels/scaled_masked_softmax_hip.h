    ...
    int attn_heads)
{
    ...
    if (key_seq_len == 0) {
        ...
        switch (log2_elements) {
            case 0: // 1
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 0>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 1: // 2
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 1>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 2: // 4
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 2>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 3: // 8
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 3>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 4: // 16
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 4>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 5: // 32
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 5>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 6: // 64
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 6>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 7: // 128
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 7>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 8: // 256
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 8>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 9: // 512
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 9>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 10: // 1024
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 10>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 11: // 2048
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 11>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            case 12: // 4096
               hipLaunchKernelGGL(( scaled_softmax_warp_forward<input_t, output_t, acc_t, 12>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, scale, batch_count, key_seq_len);
                break;
            default:
                break;
        ...
        switch (log2_elements) {
            ...
            case 11: // 2048
               hipLaunchKernelGGL(( scaled_masked_softmax_warp_forward<input_t, output_t, acc_t, 11>)
                ...
                break;
            case 12: // 4096
               hipLaunchKernelGGL(( scaled_masked_softmax_warp_forward<input_t, output_t, acc_t, 12>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), dst, src, mask, scale, batch_count, key_seq_len, pad_batches);
                break;
            default:
                break;
        ...
        switch (log2_elements) {
            ...
            case 11: // 2048
               hipLaunchKernelGGL(( scaled_masked_softmax_warp_backward<input_t, output_t, acc_t, 11>)
                ...
                break;
			case 12: // 4096
               hipLaunchKernelGGL(( scaled_masked_softmax_warp_backward<input_t, output_t, acc_t, 12>)
                    , dim3(blocks), dim3(threads), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), grad_input, grad, output, scale, batch_count, key_seq_len);
                break;
