...
class AnnealingLR(object):
    ...
    def __init__(self, optimizer, max_lr, min_lr,
                 warmup_steps, cooldown_steps, decay_steps, decay_style, warmup_style,
    ...
    def get_lr(self):
        ...
        elif self.decay_style == 'trapezoidal':
            if self.decay_steps - self.num_steps < self.cooldown_steps:
                coeff = 1.0 - (self.decay_steps - self.num_steps) / self.cooldown_steps
            else:
                coeff = 1.0
        else:
